...
#below is the full norm but instead of desegregating it prints the gbwt update information to some files.
# NORM_BASE=nygc_snp1kg_grch38.combined.n32.desegregated.normalized
# SEGREGATED_BASE=nygc_snp1kg_grch38.combined.n32.segregated-regions
# nice time vg normalize -E ${SEGREGATED_BASE}.export-gbwt-desegregation --run_tests -g ${SEGREGATED_BASE}.gbwt -r ${SEGREGATED_BASE}.gbwt.gg -t 30 -T 8 -n 32 -S ${SEGREGATED_BASE}-data.txt ${SEGREGATED_BASE}.pg
# here is the "full normalize run that I want to run after debugging," but with stderr saved to a file.
# nice time vg normalize --run_tests -g nygc_snp1kg_grch38.combined.n32.segregated-regions.gbwt -r nygc_snp1kg_grch38.combined.n32.segregated-regions.gbwt.gg -t 30 -T 8 -n 32 -o nygc_snp1kg_grch38.combined.n32.desegregated.normalized.gbwt -S nygc_snp1kg_grch38.combined.n32.segregated-regions-data.txt nygc_snp1kg_grch38.combined.n32.segregated-regions.pg > nygc_snp1kg_grch38.combined.n32.desegregated.normalized.pg 2>nygc_snp1kg_grch38.combined.n32.desegregated.normalized.pg.stderr.txt
#SAME AS immediately above, only using 6 threads for update gbwt. And tracks memory using verbose time.
# nice time -v vg normalize --run_tests -g nygc_snp1kg_grch38.combined.n32.segregated-regions.gbwt -r nygc_snp1kg_grch38.combined.n32.segregated-regions.gbwt.gg -t 30 -T 6 -n 32 -o nygc_snp1kg_grch38.combined.n32.desegregated.normalized.gbwt -S nygc_snp1kg_grch38.combined.n32.segregated-regions-data.txt nygc_snp1kg_grch38.combined.n32.segregated-regions.pg > nygc_snp1kg_grch38.combined.n32.desegregated.normalized.pg 2>nygc_snp1kg_grch38.combined.n32.desegregated.normalized.pg.stderr.txt
